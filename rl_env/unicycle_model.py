...
"""Implementation of the unicycle (acceleration, steering) dynamics model.

The unicycle model uses acceleration and curvature as the action space, with
...
class InvertibleUnicycleModel(DynamicsModel):
  ...
  @jax.named_scope('InvertibleUnicycleModel.compute_update')
  def compute_update(
      self,
