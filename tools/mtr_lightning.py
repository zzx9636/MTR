...
def train(cfg_file, pretrained_model, freeze_pretrained):
    ...
    logger = WandbLogger(project='lpp', entity='kaichiehhsu', log_model=True)
    ...
    trainer = pl.Trainer(
        ...
        callbacks=[
            ModelCheckpoint(
                dirpath=f'output/heatmap_bc_atten_{num_decoder}_{freeze_str}_ce',
                save_top_k=10,
                save_last=True,
...
if __name__ == '__main__':
    train(
        '/home/kai/Desktop/mtr/tools/cfgs/waymo/heatmap_bc+10_percent_data.yaml',
        '/Data/checkpoint_epoch_30.pth',
        True
    )
