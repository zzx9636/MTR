...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, tgt, memory,
        ...
        """
        # query_sine_embed = torch.zeros_like(query_sine_embed)
        ...
        if not self.rm_self_attn_decoder:
            ...
            tgt2, weight = self.self_attn(q, k, value=v, attn_mask=tgt_mask,
        ...
        if self.use_local_attn:
            ...
            tgt2, ca_weight = self.cross_attn(query=q,
                                   key=k,
